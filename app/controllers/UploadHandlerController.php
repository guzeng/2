...
class UploadHandlerController extends BaseController{
    ...
    function __construct($options = null, $initialize = false, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/'.Files::uploadDir('temp').'/',
            'upload_url' => $this->get_full_url().'/'.Files::uploadDir('temp').'/',
            'user_dirs' => false,
            'mkdir_mode' => 0777,
            'param_name' => 'files',
     ...
     * initialize
     * 
     * @param $thumbnail_max_width      设置缩略图的最大宽度
     * @param $thumbnail_max_height     设置缩略图的最大高度
     * @param $other_max_width          设置图片的最大宽度
     * @param $other_max_height         设置图片的最大高度
     * @2014/4/28
     * @author alex
     */
    protected function initialize($thumbnail_max_width = null,$thumbnail_max_height = null,$other_max_width = null,$other_max_height = null) 
    {
        ...
        if($other_max_width!=null || $other_max_height!=null)
        {
            $this->options['image_versions'][''] = array('max_width' => $other_max_width,'max_height' => $other_max_height);
        }   
    ...
    /**
     * get_basename
     * 解决basename函数不能取到中文文件名问题
     * 
     * @param $name         文件路径
     * @2014/5/21
     * @author Leno
     */
    protected function get_basename($name)
    {
    ...
    public function post($print_response = true) {
        ...
        if ($upload && is_array($upload['tmp_name'])) {
            ...
            //$files['org_name'] = $upload['name'][$index];
        } else {
