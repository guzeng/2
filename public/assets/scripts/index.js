    ...
    return {
        ...
        initCharts: function () {
            ...
            function showTooltip(title, x, y, contents) {
                $('<div id="tooltip" class="chart-tooltip"><div class="date m-b-5">' + title + '<\/div><div class="label label-success"> ' + contents + '<\/div><\/div>').css({
                    position: 'absolute',
                    display: 'none',
                    top: y - 100,
                    width: 80,
            ...
            if ($('#site_statistics').size() != 0) {
                ...
                var plot_statistics = $.plot($("#site_statistics"), [ {
                        data: visitors,
                        label: msg.login_count
                    },{
                        data: avi_time,
                        label: msg.avi_time+" ("+msg.minutes+")"
                    }
                ], {
                    series: {
                        lines: {
                ...
                $("#site_statistics").bind("plothover", function (event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint != item.dataIndex) {
                            ...
                            $("#tooltip").remove();
                            var x = date[item.dataIndex][1],//item.datapoint[0].toFixed(2),
                                y = item.datapoint[1];
                            showTooltip(x, item.pageX, item.pageY, y);
                        }
                    } else {
                        $("#tooltip").remove();
                        previousPoint = null;
