...
function mapInit()
{
    ...
    map.clearOverlays();
    map.centerAndZoom($('#city_id option:selected').attr('n'), 13); //new BMap.Point(116.404, 39.915)
...
function drive(address)
{
    ...
    var type = $('#type').val();
    var airport = $('#airport_id  option:selected').attr('n');
...
function price(d)
{
    ...
    price = one_num*49+two_num*39+special_num*69;
    if(d > 40)
    {
        price += parseInt(d)-40;
    }
